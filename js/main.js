...
// Reset auto timer when using controls
...
// Auto-scroll for small carousel
const SMALL_CAROUSEL_INTERVAL = 6000; // 6s
...
document.addEventListener("DOMContentLoaded", () => {
  // Select all sections and gallery images to animate on scroll
